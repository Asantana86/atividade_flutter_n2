...
class _DashboardPageState extends State<DashboardPage>
  ...
  static const _abasStatus = <StatusOS?>[
    null,
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      osController.carregarOrdens(abaStatus: _abasStatus[_tabController.index]);
    });
  }
  ...
  StatusOS? get _abaAtual => _abasStatus[_tabController.index];
  ...
  Future<void> _recarregarOrdensDaAbaAtual() async {
    await osController.carregarOrdens(abaStatus: _abaAtual);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                if (recarregar == true) {
                  await _recarregarOrdensDaAbaAtual();
                }
              },
            ),
      ...
      body: TabBarView(
        ...
        children: [
          OrdemServicoListView(controller: osController, status: null),
